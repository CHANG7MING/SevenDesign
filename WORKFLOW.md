...
5. Run [`skills/component-intelligence/SKILL.md`](./skills/component-intelligence/SKILL.md) to choose component ownership from the product task; load [`skills/react-bits/SKILL.md`](./skills/react-bits/SKILL.md) only when Bits is selected as the expression layer
...
1. Invoke the unified router [`skills/seven-design/SKILL.md`](./skills/seven-design/SKILL.md), then load [`skills/design-core/SKILL.md`](./skills/design-core/SKILL.md) for the inspect → direct → build → verify loop and [`skills/component-intelligence/SKILL.md`](./skills/component-intelligence/SKILL.md) for source ownership
...
4. When Component Intelligence selects a concrete public React Bits or Vue Bits expression, load [`skills/react-bits/SKILL.md`](./skills/react-bits/SKILL.md) and keep its motion inside the selected `micro`, `system`, or `signature` tier
